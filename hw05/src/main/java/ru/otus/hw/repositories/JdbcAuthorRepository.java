...
public class JdbcAuthorRepository implements AuthorRepository {
    ...
    public List<Author> findAll() {
        return jdbcNamedParams.query("select id, full_name from authors", new AuthorRowMapper());
    }

    @Override
    public Optional<Author> findById(long id) {
        var authors = jdbcNamedParams.query("select id, full_name from authors where id = :id",

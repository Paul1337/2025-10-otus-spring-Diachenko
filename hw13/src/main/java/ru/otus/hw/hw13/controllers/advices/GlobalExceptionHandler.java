package ru.otus.hw.hw13.controllers.advices;
...
import ru.otus.hw.hw13.dto.error.ErrorDto;
import ru.otus.hw.hw13.dto.error.ErrorType;
...
public class GlobalExceptionHandler {
    ...
    public ErrorDto handleAccessDeniedException(AccessDeniedException ex) {
        log.error("", ex);
        return new ErrorDto(ErrorType.FORBIDDEN, "Access denied");
    }
